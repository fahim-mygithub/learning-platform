...
AI-powered content analysis pipeline that transforms source materials (videos, PDFs, URLs) into structured learning content through transcription, concept extraction, knowledge graph construction, and roadmap generation.
...
- **source-management**: Sources trigger analysis pipeline
- **project-management**: Projects contain concepts and roadmaps
- **user-authentication**: Analysis results scoped to authenticated user
